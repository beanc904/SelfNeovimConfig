...
-- debug keymap
vim.keymap.set("n", "<F5>", function() dap.continue() end, { desc = "Start / Continue Debug" })
vim.keymap.set("n", "<S-F5>", function() dap.terminate() end, { desc = "End Debug" })
vim.keymap.set("n", "<F10>", function() dap.step_over() end, { desc = "Step Over" })
vim.keymap.set("n", "<F11>", function() dap.step_into() end, { desc = "Step Into" })
vim.keymap.set("n", "<F12>", function() dap.step_out() end, { desc = "Step Out" })
vim.keymap.set("n", "<F9>", function() dap.toggle_breakpoint() end, { desc = "Toggle Breakpoint" })
vim.keymap.set("n", "<Leader>db", function() dap.set_breakpoint(vim.fn.input("set Conditional Breakpoint: ")) end, { desc = "Set Conditional Breakpoint" })
